...
(function (core) {
    ...
    class AlertView extends core.DialogExt {
        ...
        createChildren() {
            ...
            if (core.API.commonPanelSkin) {
                this.imgBg.skin = core.API.commonPanelSkin;
                this.imgBg.sizeGrid = core.API.commonPanelSizeGrid;
            }
            else {
            ...
            if (core.API.commonButtonSkin) {
                this.btnYes.skin = core.API.commonButtonSkin;
                this.btnYes.sizeGrid = core.API.commonButtonSizeGrid;
                this.btnYes.stateNum = core.API.commonButtonStateNum;
            }
            else {
            ...
            if (core.API.commonButtonSkin) {
                this.btnNot.skin = core.API.commonButtonSkin;
                this.btnNot.sizeGrid = core.API.commonButtonSizeGrid;
                this.btnNot.stateNum = core.API.commonButtonStateNum;
            }
            else {
