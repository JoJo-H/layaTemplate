...
(function (util) {
    class date {
         ...
         */
        static toCountdown(time, format, type = 0) {
            let day;
            let hour;
            if (type == 1) {
                day = 0;
        ...
        /**当月有多少天 */
        static getMonthDays() {
            let curDate = new Date(common.App.serverTimeSecond * 1000);
         ...
         * @param second 秒
         */
        static getFormatTime(serverTime, week, hour, minu, second = 0) {
            let date = new Date();
